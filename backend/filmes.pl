...
filme(schuleraustausch).
genero(schuleraustausch, comedia).
genero(schuleraustausch, cinema_tv).
nota(schuleraustausch, 59).
ano(schuleraustausch, 2006).
...
filme(evangelion_30+:_30th_anniversary_special).
genero(evangelion_30+:_30th_anniversary_special, animacao).
genero(evangelion_30+:_30th_anniversary_special, ficcao_cientifica).
genero(evangelion_30+:_30th_anniversary_special, comedia).
nota(evangelion_30+:_30th_anniversary_special, 77).
ano(evangelion_30+:_30th_anniversary_special, 2026).
...
filme(socias_por_accidente).
genero(socias_por_accidente, comedia).
nota(socias_por_accidente, 40).
ano(socias_por_accidente, 2026).
...
filme(lyrics_from_a_bleeding_heart).
genero(lyrics_from_a_bleeding_heart, drama).
nota(lyrics_from_a_bleeding_heart, 10).
ano(lyrics_from_a_bleeding_heart, 2018).
